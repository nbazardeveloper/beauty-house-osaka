...
const NewsLatterBox = () => {
  ...
  // Ждем, пока компонент смонтируется, чтобы безопасно использовать theme
  useEffect(() => {
    setMounted(true);
  }, []);

  // Цвет по умолчанию для сервера и первого рендера
  const activeColor = mounted && theme === "dark" ? "#fff" : "#4A6CF7";
        ...
        <span className="absolute left-2 top-7">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stopColor={activeColor} stopOpacity="0.62" />
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop offset="0.328125" stopColor={activeColor} />
                <stop offset="1" stopColor={activeColor} stopOpacity="0" />
              </linearGradient>
              <linearGradient
